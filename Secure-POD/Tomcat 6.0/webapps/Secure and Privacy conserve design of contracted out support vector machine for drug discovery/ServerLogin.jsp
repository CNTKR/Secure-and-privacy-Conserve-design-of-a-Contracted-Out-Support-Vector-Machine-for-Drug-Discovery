...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Welcome To  CSP Login..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p><img src="images/Login.jpg" width="208" height="146" /></p>
            <form id="form1" name="form1" method="post" action="ServerAuthentication.jsp">
				    <table width="464" border="0" cellspacing="2" cellpadding="2">
                      <tr>
                        <td width="197" height="46" align="justify" bgcolor="#0000FF"><span class="style34 style4 style9">
                          <label for="name"><span class="style10">Name (required)</span></label>
                        </span> </td>
                        <td width="253"><input id="name" name="serverid" class="text" /></td>
                      </tr>
                      <tr>
                        <td height="40" align="justify" bgcolor="#0000FF"><span class="style8">Password (required)</span></td>
