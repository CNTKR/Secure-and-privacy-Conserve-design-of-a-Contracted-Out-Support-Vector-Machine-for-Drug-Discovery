...
<head>
<title>DrugFormulaProviders Profile</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4"> <%=(String)application.getAttribute("ptname")%>'s Profile..</h2>
          <div class="clr"></div>
		  ...
		  <table width="500" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						String user=(String )application.getAttribute("ptname");						
						...
						try 
						{
						   	String query="select * from patient where patientname='"+user+"'"; 
            ...
            <%
				  ...
				  <p>&nbsp;</p>
				  <p align="right" class="style14"><a href="DrugFormulaProvidersMain.jsp" class="style13">Back</a></p>
