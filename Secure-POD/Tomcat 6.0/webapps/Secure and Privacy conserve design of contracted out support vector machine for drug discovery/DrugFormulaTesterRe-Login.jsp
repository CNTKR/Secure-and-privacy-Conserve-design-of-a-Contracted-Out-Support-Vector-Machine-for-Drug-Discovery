...
<head>
<title>Drug Formula Tester Re-Login</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p>&nbsp;</p>
            <form id="form1" name="form1" method="post" action="Drug Formula TesterAuthentication.jsp">
				   					
					<table width="493" border="0" cellspacing="2" cellpadding="2">
					 <tr>
                       <td width="159" height="33"><div align="justify"><span class="style6">Select Hospital Name </span></div></td>
                        <td width="270"><label>
                      ...
                      <tr>
                        <td width="159" height="46" align="justify"><span class="style6">
                          <label for="name">User Name (required)</label>
                        </span> </td>
                        <td width="270"><input id="uname" name="userid" class="text" /></td>
                      </tr>
                      <tr>
                        <td height="40" align="justify"><span class="style6">Password (required)</span></td>
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <td width="37"></span><td width="1"></td>
                      </tr>
