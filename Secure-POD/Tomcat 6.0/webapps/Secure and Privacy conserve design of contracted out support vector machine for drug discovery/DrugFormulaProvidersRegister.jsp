...
<head>
<title>DrugFormulaProviders Register</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Welcome To Drug Formula Providers Registration..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p><img src="images/Register.jpg" width="330" height="152" /></p>
            
			<form action="DrugFormulaProvidersRegisterStatus.jsp" method="post" id="" enctype="multipart/form-data">
                    					
			  <span class="style6">
			  <label for="name"><span class="style3">DrugFormulaProviders Name (required)</span></label>
			  </span>
                    <p class="style10">
                    ...
                    <p>&nbsp;</p>
			        <p align="left" class="style14"><a href="DrugFormulaProviderstLogin.jsp" class="style11">Back</a></p>
            </form>	  
