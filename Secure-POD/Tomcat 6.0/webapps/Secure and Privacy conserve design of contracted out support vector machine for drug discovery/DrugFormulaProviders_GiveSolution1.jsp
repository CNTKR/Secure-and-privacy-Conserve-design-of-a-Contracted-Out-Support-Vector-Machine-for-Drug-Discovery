...
<head>
<title>Solution Status Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Given Solution Status..</h2>
          <div class="clr"></div>
		  ...
		  String sol_by=(String)application.getAttribute("ptname");
		  String sol_by1=new String(Base64.encode(sol_by.getBytes()));
	...
	try {
		...
		String solution=new String(Base64.encode(sol.getBytes()));

		PreparedStatement pst=connection.prepareStatement("insert into frd_solutions(symp,ptname,solutions,sol_by,dt) values(?,?,?,?,?)");
             
			pst.setString(1,symp1);
            pst.setString(2,ptname1);
            pst.setString(3,solution);
			pst.setString(4,sol_by1);
			pst.setString(5,dt);
			...
			pst.executeUpdate();
                  ...
                  %> 
                        <span class="style4 style1 style8"><span class="style1  style12 style10"> Solution Given Successfully...</span></span>                    </div>
            <p align="center"><a href="DrugFormulaProviders_EnterPbKey.jsp?ptname=<%=ptname%>&pbkey=<%=pbkey%>" class="style47">Back</a></p>
                  <%
