...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Request Status..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
				  <%			
					...
					try {
			 			...
			 			String query1="select * from solution_req  where (symp='"+symp1+"' and ptname='"+ptname1+"') and doctor='"+doctor1+"' "; 
		          ...
		          <p align="center" class="style4" style="color:#000000"><span class="style9">Solution Request Already Sent for the Symptom</span> <%=symp%><span class="style9">..</span></p>
		          <p align="center"><a href="DrugFormulaProviders_RequestDrSoln.jsp" class="style5 style16 style35">Back</a></p>
            <p>&nbsp;            </p>
		          <p>
		            <%
...
PreparedStatement ps=connection.prepareStatement("insert into solution_req(ptname,hname,doctor,symp,dt) values(?,?,?,?,?)");
						ps.setString(1,ptname1);
						ps.setString(2,hname1);
						ps.setString(3,doctor1);
						ps.setString(4,symp1);	
						ps.setString(5,dt);
		          ...
		          <p class="style23">&nbsp;</p>
		          <p align="center" class="style10" style="color:#000000">Solution Request Sent Successfully..</p>
		          <p class="style19">&nbsp;</p>
