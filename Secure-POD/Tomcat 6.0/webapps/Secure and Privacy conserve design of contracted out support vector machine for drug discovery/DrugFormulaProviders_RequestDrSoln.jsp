...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Requesting Drug Formula Tester Solution By Selecting Hospital and Drug Formula Tester..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
               ...
               <tr>
				 ...
				 <td  width="105" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style6" ><b>Request Solution</b></div></td>
            ...
            <tr>
			 ...
			 <td  width="105" align="center" valign="middle" height="23"><a href="DrugFormulaProviders_RequestDrSoln1.jsp?ptname=<%=ptname%>&symp=<%=symp1%>" class="style8" style="color:#660033"><b>Send Request</b></a>		  </td>
