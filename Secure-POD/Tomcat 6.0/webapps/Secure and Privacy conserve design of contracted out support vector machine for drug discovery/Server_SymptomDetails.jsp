...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Disease <%=request.getParameter("symp")%> Details..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            <table width="700" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr>
                 ...
                 <td  width="104" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style6" ><b> Disease </b></div></td>
                 ...
                 <td  width="142" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style6" ><b>Drug Formula Details </b></div></td>
            ...
            <%
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
							...
							String symp2=new String(Base64.encode(symp.getBytes()));
							
						   	String query="select * from health_record where ptname='"+ptname+"' and symp='"+symp2+"' "; 
						   	Statement st=connection.createStatement();
						   	ResultSet rs=st.executeQuery(query);
					   		while ( rs.next() )
					   		{
								j=rs.getInt(1);
								psymp=rs.getString(3);
						...
						String symp1 = new String(Base64.decode(psymp.getBytes()));
			...
			<h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Server_SymptomDetails")){%>
            <h2 align="right"><a href="Server_ViewSolnReqRes.jsp" class="style16">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("Server_FrdSoln")){%>
            <h2 align="right"><a href="Server_ViewFrdSoln.jsp" class="style16">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("Server_SameSympPts")){%>
            <h2 align="right"><a href="Server_ViewSameSympDrug Formula Providers.jsp" class="style16">Back</a></h2>
			<%}
