...
<head>
<title>Solution Details Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Drug Formula Tester <%=request.getParameter("doctor")%>'s Solution..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            <table width="577" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr>
                 <td  width="394" height="28" valign="baseline" style="color: #2c83b0;"><div align="center" class="style4 style6" ><b>Tested Result Details</b></div></td>
                 <td  width="177" height="28" valign="baseline" style="color: #2c83b0;"><div align="center" class="style4 style6" ><b>Tested Result  Response Date </b></div></td>
		...
		<div align="left" class="style22">
		  <div align="center"><a href="Server_ViewSolnReqRes.jsp" class="style12">Back</a></div>
		</div>
