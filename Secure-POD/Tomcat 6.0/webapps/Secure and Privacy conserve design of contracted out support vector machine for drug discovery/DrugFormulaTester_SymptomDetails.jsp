...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
<h2 align="center" class="style4">Disease <%=request.getParameter("symp")%> Details</span></h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            <table width="700" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr>
                 ...
                 <td  width="142" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style6" ><b>Drug Fomula For Symptoms  </b></div></td>
			...
			<h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("DrugFormulaTester_SymptomDetails")){%>
            <h2 align="right"><a href="Drug Formula Tester_SolutionRequests.jsp" class="style16">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("DrugFormulaTester_SolutionDetails")){%>
            <h2 align="right"><a href="DrugFormulaTester_ViewSolutions.jsp" class="style16">Back</a></h2>
			<%}
