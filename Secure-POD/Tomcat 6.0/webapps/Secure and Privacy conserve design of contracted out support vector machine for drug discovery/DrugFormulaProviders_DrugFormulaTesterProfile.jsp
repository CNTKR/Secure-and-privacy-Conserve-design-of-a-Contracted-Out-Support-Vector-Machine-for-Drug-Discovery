...
<head>
<title>Drug Formula Tester Profile</title>
      ...
      <div class="mainbar">
        <div class="article">
		  ...
		  <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
			...
			<h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("DrugFormulaProviders_Drug Formula TesterProfile")){%>
            <h2 align="right"><a href="DrugFormulaProviders_ViewDrSoln.jsp?ptname=<%=ptname%>&symp=<%=symp%>" class="style15">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("DrugFormulaProviders_Sample")){%>
            <h2 align="right"><a href="DrugFormulaProviders_ViewSample.jsp" class="style15">Back</a></h2>
			<%}
