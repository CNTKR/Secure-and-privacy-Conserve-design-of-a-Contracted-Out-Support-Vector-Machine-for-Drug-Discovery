...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Drug Formula Tester <%=request.getParameter("doctor")%>'s Solution Details..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
				  <table width="486" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr>
                 <td  width="316" height="34" valign="baseline" style="color: #660033;"><div align="center" class="style6"><b>Given Solution</b></div></td>
                 <td  width="164" height="34" valign="baseline" style="color: #660033;"><div align="center" class="style6"><b>Solution Given Date </b></div></td>
					 ...
					 String symp1=new String(Base64.decode(symp.getBytes())); 
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
						   	...
						   	String query="select * from doctor_soln where (symp='"+symp+"' and ptname='"+ptname+"') and (hname='"+hname+"' and  doctor='"+doctor1+"')  "; 
		...
		<div align="left" class="style22">
		  <div align="center"><a href="DrugFormulaProviders_ViewDrSoln.jsp?ptname=<%=ptname1%>&symp=<%=symp1%>" class="style11">Back</a></div>
		</div>
