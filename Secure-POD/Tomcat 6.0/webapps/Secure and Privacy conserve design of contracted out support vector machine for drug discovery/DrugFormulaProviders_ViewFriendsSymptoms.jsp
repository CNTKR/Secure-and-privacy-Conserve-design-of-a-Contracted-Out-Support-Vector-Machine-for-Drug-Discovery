...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Enter Your Public Key to View Your Friends Symptoms..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
			 <form id="form1" method="post" action="DrugFormulaProviders_EnterPbKey.jsp">
              <table width="392" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  <td width="148"><span class="style49 style4 style10">Enter Public Key:</span></td>
                  <td width="230"><input type="text" name="pbkey" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><input type="submit" value="Submit" style="width:80px; height:30px; background-color:#660000; color:#FFFFFF;"/></td>
                </tr>
              </table>
              <p align="center">&nbsp;</p>
              <p align="center"><a href="DrugFormulaProvidersMain.jsp" class="style75">Back</a></p>
            </form>
