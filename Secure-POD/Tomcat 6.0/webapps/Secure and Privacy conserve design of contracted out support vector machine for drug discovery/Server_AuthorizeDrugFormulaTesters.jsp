...
<head>
<title>Authorize Drug Formula Testers</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Authorize All Drug Formula Testers..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
				  ...
				  <table width="592" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
                      ...
                      <td  width="116" valign="middle" height="34" style="color: #660000;"><div align="center" class="style5 style56 style57"><b>Drug Formula Tester Image</b></div></td>
					  <td  width="109" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Hospital Name</b></div></td>
                      <td  width="109" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Drug Formula Tester Name</b></div></td>
                    ...
                    <tr>
                      ...
                      <td width="116" rowspan="1" align="center" valign="middle" ><div class="style5 style37 style54 style55 style22" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                          <input  name="image" type="image" src="doctor_Pic.jsp?id=<%=i%>" style="width:90px; height:90px;" />
                      </a> </div></td>
                      ...
                      <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style20 style37 style46"><a href="Server_Drug Formula TesterStatus.jsp?id=<%=i%>" class="style6">waiting</a></div>
                      </div></td>
                      <%
						}
						else
