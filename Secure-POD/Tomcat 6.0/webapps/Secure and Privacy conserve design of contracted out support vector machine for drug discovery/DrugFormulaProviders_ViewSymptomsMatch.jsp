...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Enter Your Private Key to View Your Friends Matching Symptoms..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
			 <form id="form1" method="post" action="DrugFormulaProviders_EnterPvKey.jsp">
              <table width="392" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  <td width="148"><span class="style49 style4 style10">Enter Private Key:</span></td>
                  <td width="230"><input type="text" name="pvkey" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
