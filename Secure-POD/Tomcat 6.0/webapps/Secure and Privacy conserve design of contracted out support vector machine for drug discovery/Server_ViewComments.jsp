...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Comments on Symptom <%=request.getParameter("symp") %>..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            <table width="700" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr>
				 ...
				 <td  width="73" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style6" ><b>Commented By</b></div></td>
		...
		<div align="left" class="style22">
		  <div align="right"><a href="Server_ViewPatientSymptoms.jsp" class="style11">Back</a></div>
		</div>
