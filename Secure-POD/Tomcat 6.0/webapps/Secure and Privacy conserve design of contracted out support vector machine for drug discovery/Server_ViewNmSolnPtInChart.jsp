...
<head>
<title>Number Of Drug Formula Providers Got Solutions</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Number of Drug Formula Providers got Solutions for Symptoms from Drug Formula Tester and Friends..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
            
				  
				  <iframe width="450" height="300" src="Server_ViewNmSolnPtInChart1.jsp"></iframe>
			  				<br/>
			  				<span class="style1 style9">( Number of Drug Formula Providers Based on Drug Formula Tester Solutions )</span>
			  				<p>&nbsp;</p>
