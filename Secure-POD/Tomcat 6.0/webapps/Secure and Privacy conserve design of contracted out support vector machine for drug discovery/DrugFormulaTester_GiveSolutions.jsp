...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
<h2 align="center" class="style4">Give Solution..</h2>
          <div class="clr"></div>
		  ...
		  %>
            ...
            <form name="s" action="DrugFormulaTester_GiveSolutions1.jsp?ptname=<%=ptname%>&symp=<%=symp%>&hname=<%=hname%>" method="post"  onSubmit="return valid()"  ons target="_top">
	...
	<table width="600" border="0" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr><td></td><td></td>
 						<td   width="200" align="left" valign="middle" height="45" style="color: #2c83b0;"><div align="right" class="style9 style4 style8"  style="margin-left:20px;">Enter Tested Result </div></td>
				      ...
				      <input type="submit" value="Submit Tested Result" style="width:200px; height:35px; background-color:#006633; color:#FFFFFF;"/>
					    </span></td>
					</tr>
          </table>
		...
		<div align="left" class="style22">
		  <div align="center"><a href="DrugFormulaTester_SolutionRequests.jsp" class="style11">Back</a></div>
		</div>
