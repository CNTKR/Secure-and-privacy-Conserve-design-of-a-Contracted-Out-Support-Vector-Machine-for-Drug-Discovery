...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Tester. <%=(String)application.getAttribute("duname")%>'s Profile..</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
                    ...
                    <%
						...
						String user=(String )application.getAttribute("duname");
				  ...
				  <p>&nbsp;</p>
				  <p align="right" class="style14"><a href="DrugFormulaTesterMain.jsp" class="style13">Back</a></p>
