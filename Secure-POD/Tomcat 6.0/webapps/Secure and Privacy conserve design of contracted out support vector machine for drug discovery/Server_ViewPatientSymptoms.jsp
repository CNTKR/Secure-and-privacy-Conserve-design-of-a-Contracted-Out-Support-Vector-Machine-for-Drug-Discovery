...
<head>
<title>All Drug Formula Providers Symptoms</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">All Patient Symptoms with Comments</h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
               ...
               <tr>
				 ...
				 <td  width="110" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style6" ><b> Drug Formula Provider Name </b></div></td>
				 ...
				 <td  width="105" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style6" ><b>Drug Formula </b></div></td>
            ...
            <%
					  ...
					  String ptname="",symp="",sdesc="",age="",cno="",mail="",address="",ameasure="",date="";
            ...
            <%
					...
					if(count==0){out.print("No Patient Has Uploaded Any Symptom Details");}
		...
		<div align="left" class="style22">
		  <div align="right"><a href="ServerMain.jsp" class="style11">Back</a></div>
		</div>
