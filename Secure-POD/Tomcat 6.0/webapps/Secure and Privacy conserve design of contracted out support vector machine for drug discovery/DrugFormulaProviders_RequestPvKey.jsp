...
<head>
<title>Request Private Key</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4">Request Private Key..</h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
		  			<form action="DrugFormulaProviders_RequestPvKey.jsp" method="post">
				<div align="center">
				  <input type="hidden" value=<%="reqkey"%> name="reqkey"/>
				  <input type="submit" name="Submit" value="Request Private Key" style="height:40px;width:180px;" />
			      </div>
            </form>
            <div align="center">
              <p class="style51">&nbsp;</p>
			    ...
			    <%
						...
						{
										String query="select pvkey from pvkey_req where ptname='"+ptname+"' "; 
								   ...
								   PreparedStatement ps=connection.prepareStatement("insert into pvkey_req(ptname,pvkey,reqdt,resdt) values(?,?,?,?)");
											...
											%><p><span class="style57 style10">Private Key Requested Successfully.. </span></p>
<%
										}
										else if (s1.equalsIgnoreCase("waiting"))
										{
										
											%><p><span class="style57 style10">Private Key is Not Generated for You!!.. </span></p>
<%
										}
										else 
										{
										
											%><p><span class="style54 style23">Your Private Key is : </span><span class="style22"><%=s1%></span></p>
<%
										}
						}
